...
> 打造从数据建模、策略定义到交易执行的完整闭环，借助[模型对象管理](./StrategyDefinition.md)工具来设计您的数据建模，通过[交易规则](./StrategyDefinition.md)、[因子库设计](./StrategyDefinition.md)、[自选股](./StrategyDefinition.md)以及
