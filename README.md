...
> 打造从数据建模、策略定义到交易执行的完整闭环，借助[模型对象管理](./StrategyDefinition.md)工具来设计您的数据建模，、[模型对象管理](./StrategyDefinition.md)、[模型对象管理](./StrategyDefinition.md)、[模型对象管理](./StrategyDefinition.md)
